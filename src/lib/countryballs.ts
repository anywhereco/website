...
const STORAGE_KEY = 'heredita.avatar';
  ...
  function saveAvatar(a) {
    ...
    localStorage.setItem(STORAGE_KEY, JSON.stringify(sanitizeToUnlocked(a)));
  }
...
export {
  FLAGS, ACCESSORIES, MODERN_IDS, ALT_IDS,
  DEFAULT_AVATAR, UNLOCKED_COUNTRY, UNLOCKED_ACCESSORY,
  isCountryLocked, isAccessoryLocked,
  sanitizeToUnlocked,
  getAvatar, saveAvatar, clearAvatar,
  buildBallSVG, buildFlagPreviewSVG
};
